...
public class arrival_Calender {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					arrival_Calender window = new arrival_Calender();
	...
	private void initialize() {
		...
		btn_check.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				...
				resultDdate = date;
				resultDday = day;
				JOptionPane.showMessageDialog(null, "µµ¬¯¿œ º±≈√ øœ∑·!", "µµ¬¯¿œ", JOptionPane.INFORMATION_MESSAGE);
				frame.dispose();
