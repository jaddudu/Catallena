...
public class QQatar_LogMain {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					QQatar_LogMain window = new QQatar_LogMain();
	...
	private void initialize() {
		...
		btn_bjoin.setBounds(588, 401, 120, 15);
		btn_bjoin.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {

				QQatar_bjoin.main(null);
		...
		btn_join.setBounds(461, 401, 92, 15);
		...
		btn_login.setBounds(746, 401, 75, 15);
