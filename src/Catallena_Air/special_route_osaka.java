...
public class special_route_osaka {
   ...
   public static void main(String[] args) {
      EventQueue.invokeLater(new Runnable() {
         public void run() {
            try {
               special_route_osaka window = new special_route_osaka();
   ...
   private void initialize() {
      ...
      JRadioButton rdbtnNewRadioButton = new JRadioButton("");
       rdbtnNewRadioButton.setBounds(1023, 364, 121, 23);
      ...
      Image image = new ImageIcon("../Catallena/src/CatallenaImage/special_route_osaka.png").getImage().getScaledInstance(1280, 694, Image.SCALE_SMOOTH);
      ...
      btn_login.setBounds(1145, 628, 123, 45);
